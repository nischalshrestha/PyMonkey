...
class EvaluatorTest(unittest.TestCase):
    ...
    def test_hash_literals(self):
        ...
        for key, value in expected.items():
            hash_key = None
            exists = False
            # Issue: HashKey objects are freshly created so can't compare
            # equivalence with expected HashKey and one generated by Eval..
            # this is hacky solution that works for now
